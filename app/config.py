...
class Settings():
    ...
    MIN_ALLOWED_FILLING_DIFFERENCE: float = 1.5 # Maximum allowed filling difference in cm
    MAX_ALLOWED_FILLING_DIFFERENCE: float = 2.5 # Maximum allowed filling difference in cm
    MAX_ALLOWED_DRAINING_DIFFERENCE: float = 2.1 # Maximum allowed draining difference in cm
    MIN_ALLOWED_DRAINING_DIFFERENCE: float = 1.1 # Minimum allowed filling difference in cm
    ...
    MAX_RETRY_COUNT: int = 3 # Maximum retry count for validation
    SENSOR_2_CALIBRATION: int = 90 # Sensor 2 calibration value in cm
