...
class Settings():
    ...
    MIN_ALLOWED_FILLING_DIFFERENCE: float = 1.8 # Maximum allowed filling difference in cm
    MAX_ALLOWED_FILLING_DIFFERENCE: float = 2.8 # Maximum allowed filling difference in cm
    MAX_ALLOWED_DRAINING_DIFFERENCE: float = 2.5 # Maximum allowed draining difference in cm
    MIN_ALLOWED_DRAINING_DIFFERENCE: float = 1.5 # Minimum allowed filling difference in cm
