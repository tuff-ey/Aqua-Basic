...
class Settings():
    ...
    MIN_ALLOWED_FIRST_PASS_DIFFERENCE: float = 1.5 # Maximum allowed filling difference in cm
    ...
    RATE_OF_FILLING: float = 1.23 # Rate of filling in cm/min
    ...
    FILLING_DURATION_CALIBRATION_TIME = 1 # Average time taken to detect the filling has started in minutes
